...
Öffne `src/index.html`, um die barrierearme Demo aufzurufen. Dort kannst du Farb-Themes wählen, die Schriftgröße regulieren und per Button nur die **Schriftfarben** invertieren (Hintergründe bleiben stabil). Ein Debug-Schalter blendet zusätzliche Meldungen im Statusprotokoll ein.
